Projeto IoT - Sistema inteligente de filas para restaurantes e food trucks
...
1 LCD para mostrar a quantidade de pessoas localmente.

1 ESP32 para enviar os dados para a nuvem e exibir na tela do usuário.
